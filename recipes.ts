...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    ...
    instructions: [
      ...
      'Then drain the beans and keep your cooking water. In the same pot, add the potatoes and the bean cooking water.',
  ...
  },
  {
    id: '8',
    name: 'Koki',
    description: 'Cameroonian recipe known to all. Rich, nourishing and consistent',
    imageUrl: 'https://i.pinimg.com/736x/77/a6/c1/77a6c10851beaae57e33649128d18858.jpg',
    videoUrl: 'https://youtu.be/qxDZyuzsqMk?si=swmLJdlTywVmjjFj',
    prepTime: 60,
    cookTime: 300,
    servings: 8,
    difficulty: 'hard',
    ...
    instructions: [
      ...
      'Finely crush the koki grains, pour them into a bowl and add salt.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '2', name: '', quantity: 1, unit: 'tbsp' },
      { id: '3', name: '', quantity: 300, unit: 'ml' },
      { id: '4', name: '', quantity: 500, unit: 'g' },
      { id: '5', name: '', quantity: 300, unit: 'g' },
      { id: '6', name: '', quantity: 100, unit: 'g' },
      { id: '7', name: '', quantity: 2, unit: 'tbsp' },
      { id: '8', name: '', quantity: 100, unit: 'g' },
      { id: '9', name: '', quantity: 1, unit: 'medium' },
      { id: '10', name: '', quantity: 2, unit: 'inches' },
      { id: '11', name: '', quantity: 5, unit: 'cloves' },
      { id: '12', name: '', quantity: 1, unit: 'tbsp' },
    ],
    instructions: [
      '',
      '',
  ...
  },
  {
    ...
    name: 'BHB',
    description: 'A delicious recipe from Cameroon made with fresh sweet corn and pinto beans cooked in fresh spices and palm oil. A definite crowd pleaser and easy to make....',
    imageUrl: 'https://i.pinimg.com/736x/60/6b/33/606b33806f3405d4ff10a12154a14edd.jpg',
    videoUrl: 'https://example.com/achu-video.mp4',
    prepTime: 15,
    cookTime: 30,
    servings: 8,
