...
export const mockRecipes: Recipe[] = [
  {
    ...
    difficulty: 'medium',
    ingredients: [
      { id: '1', name: 'Bitter leaves', quantity: 1, unit: 'g' },
      { id: '2', name: 'Grind Groundnuts', quantity: 1, unit: 'tbsp' },
      { id: '3', name: 'Beef/Smoked fish', quantity: 1, unit: 'g' },
      { id: '4', name: 'Crayfish', quantity: 2, unit: 'g' },
      { id: '5', name: 'Onions', quantity: 2, unit: 'medium' },
      { id: '6', name: 'Garlic', quantity: 1, unit: 'cloves' },
      { id: '7', name: 'Palm oil', quantity: 1, unit: 'ml' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '2', name: 'Ripe plantains', quantity: 1, unit: 'medium' },
      { id: '3', name: 'Tomatoes', quantity: 1, unit: 'large' },
      { id: '4', name: 'Bell peppers', quantity: 1, unit: 'medium' },
      { id: '5', name: 'Onions', quantity: 1, unit: 'large' },
      { id: '6', name: 'Garlic', quantity: 1, unit: 'cloves' },
      { id: '7', name: 'Ginger', quantity: 1, unit: 'inches' },
      { id: '8', name: 'Vegetable oil', quantity: 1, unit: 'ml' },
      { id: '9', name: 'Carrots', quantity: 2, unit: 'medium' },
      { id: '10', name: 'Green beans', quantity: 1, unit: 'g' },
      { id: '11', name: 'Chicken stock cube', quantity: 1, unit: 'cubes' },
  ...
  },
  {
    ...
    difficulty: 'medium',
    ingredients: [
      { id: '1', name: 'Eru leaves', quantity: 1, unit: 'g' },
      { id: '2', name: 'Waterleaf', quantity: 1, unit: 'g' },
      { id: '3', name: 'Palm oil', quantity: 1, unit: 'ml' },
      { id: '4', name: 'Smoked meat/fish', quantity: 1, unit: 'g' },
      { id: '5', name: 'Crayfish', quantity: 1, unit: 'g' },
      { id: '6', name: 'Stock cubes', quantity: 1, unit: 'cubes' },
  ...
  },
  {
    ...
    difficulty: 'hard',
    ingredients: [
      { id: '1', name: 'Cocoyams', quantity: 1, unit: 'kg' },
      { id: '2', name: 'Kanwa/limestone', quantity: 1, unit: 'tbsp' },
      { id: '3', name: 'Palm oil', quantity: 1, unit: 'ml' },
      { id: '4', name: 'Beef/tripe', quantity: 1, unit: 'g' },
      { id: '5', name: 'Cow skin (kanda)', quantity: 1, unit: 'g' },
      { id: '6', name: 'Crayfish', quantity: 1, unit: 'g' },
      { id: '7', name: 'Pepper', quantity: 2, unit: 'tbsp' },
      { id: '8', name: 'Njangsa seeds', quantity: 1, unit: 'g' },
      { id: '9', name: 'Ripe plantain', quantity: 1, unit: 'medium' },
      { id: '10', name: 'Ginger', quantity: 2, unit: 'inches' },
      { id: '11', name: 'Garlic', quantity: 1, unit: 'cloves' },
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'Long grain rice', quantity: 1, unit: 'g' },
      { id: '2', name: 'Tomatoes', quantity: 1, unit: 'medium' },
      { id: '3', name: 'Bell peppers', quantity: 1, unit: 'medium' },
      { id: '4', name: 'Onions', quantity: 1, unit: 'large' },
      { id: '5', name: 'Vegetable oil', quantity: 1, unit: 'ml' },
      { id: '6', name: 'Chicken stock', quantity: 1, unit: 'ml' },
      { id: '7', name: 'Garlic', quantity: 1, unit: 'cloves' },
      { id: '8', name: 'Ginger', quantity: 1, unit: 'inch' },
      { id: '9', name: 'Thyme', quantity: 1, unit: 'tsp' },
      { id: '10', name: 'Bay leaves', quantity: 1, unit: 'leaves' },
  ...
  },
  {
    ...
    difficulty: 'hard',
    ingredients: [
      { id: '1', name: 'finely chopped Okok (Eru) leaves', quantity: 1, unit: 'g' },
      { id: '2', name: 'palm nut juice', quantity: 1, unit: 'g' },
      { id: '3', name: 'of roasted peanut paste', quantity: 1, unit: 'g' },
      { id: '5', name: 'water', quantity: 1, unit: 'ml' },
  ...
  },
  {
    ...
    difficulty: 'hard',
    ingredients: [
      { id: '1', name: 'potato', quantity: 1, unit: 'kg' },
      { id: '2', name: 'black beans', quantity: 1, unit: 'g' },
      { id: '3', name: 'red oil', quantity: 1, unit: 'ml' },
      { id: '4', name: 'Chilli pepper(optional)', quantity: 1, unit: 'tbps' },
      { id: '5', name: 'Water', quantity: 1, unit: 'L' },
      { id: '6', name: 'Salt', quantity: 1, unit: 'tbsp' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '5', name: 'Banana leaves (or allu…)', quantity: 1, unit: 'piece' },
      { id: '6', name: 'Twines', quantity: 1, unit: 'piece' },
      { id: '7', name: 'cocoyam leaves(optional)', quantity: 1, unit: 'piece' },
    ],
    instructions: [
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'Green Banana', quantity: 1, unit: 'kg' },
      { id: '2', name: 'Grind groundnuts', quantity: 1, unit: 'tbsp' },
      { id: '3', name: 'Red oil', quantity: 1, unit: 'ml' },
      { id: '4', name: 'smoked fish', quantity: 1, unit: 'kg' },
      { id: '5', name: 'Salt', quantity: 1, unit: 'g' },
      { id: '6', name: 'Crayfish', quantity: 1, unit: 'g' },
      { id: '7', name: 'Pepper', quantity: 1, unit: 'tbsp' },
      { id: '8', name: 'tomatoes', quantity: 1, unit: 'pieces' },
      { id: '9', name: 'Onion', quantity: 1, unit: 'piece' },
      { id: '10', name: 'Ginger', quantity: 1, unit: 'cloves' },
      { id: '11', name: 'Garlic', quantity: 1, unit: 'cloves' },
      { id: '12', name: 'maggi', quantity: 1, unit: 'cubes' }, // (optional)
      { id: '13', name: 'Sprig chives', quantity: 1, unit: 'sprig' },
      { id: '14', name: 'water', quantity: 1, unit: 'cup' },
    ],
    instructions: [
  ...
  },
   {
     ...
     ingredients: [
       ...
       { id: '2', name: 'smoked fish', quantity: 1, unit: 'pieces' },
       { id: '3', name: 'Water', quantity: 1, unit: 'l' },
       { id: '4', name: 'Salt', quantity: 1, unit: 'tbsp' },
       { id: '5', name: 'Banana leaves', quantity: 1, unit: 'pieces' },
       { id: '6', name: 'Twines', quantity: 1, unit: 'peces' },
     ],
     instructions: [
   ...
   },
  {
    ...
    ingredients: [
      ...
      { id: '2', name: ' of palm nuts', quantity: 1, unit: 'g' },
      { id: '3', name: 'of fresh corn on the cob', quantity: 1, unit: 'kg' },
      { id: '4', name: 'water', quantity: 1, unit: 'l' },
      { id: '5', name: 'sugar', quantity: 1, unit: 'g' },
      { id: '6', name: 'Pepper', quantity: 1, unit: 'tsp' },
    ],
    instructions: [
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'Vegetables', quantity: 1, unit: 'kg' },
      { id: '2', name: 'tomatoes', quantity: 1, unit: 'pieces' },
      { id: '3', name: 'leek', quantity: 1, unit: 'medium' },
      { id: '4', name: 'carrot', quantity: 1, unit: 'piece' },
      { id: '5', name: 'vegetble oil', quantity: 1, unit: 'ml' },
      { id: '6', name: 'shrimp', quantity: 1, unit: 'handful' },
      { id: '7', name: 'smoked fish', quantity: 1, unit: 'kg' },
      { id: '8', name: 'salt', quantity: 1, unit: 'tbsp' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { id: '2', name: ' Njansan', quantity: 1, unit: 'g' },
      { id: '3', name: 'onion', quantity: 1, unit: 'piece' },
      { id: '4', name: 'tomato', quantity: 1, unit: 'pieces' },
      { id: '5', name: 'mbongo spice mix', quantity: 1, unit: 'g' },
      { id: '6', name: 'Salt', quantity: 1, unit: 'tbsp' },
      { id: '7', name: 'Pepper', quantity: 1, unit: 'tbsp' },
      { id: '8', name: 'palm oil', quantity: 1, unit: 'ml' },
    ],
    instructions: [
  ...
  },
  {
    ...
    difficulty: 'hard',
    ingredients: [
      { id: '1', name: 'preferably white macaroons', quantity: 1, unit: 'kg' },
      { id: '2', name: 'banana leaves', quantity: 1, unit: 'pieces' },
      { id: '3', name: 'palm oil', quantity: 1, unit: 'tbsp' },
      { id: '4', name: 'salt', quantity: 1, unit: 'tbsp' },
      { id: '5', name: 'water', quantity: 1, unit: 'l' },
      { id: '6', name: 'of peanuts', quantity: 1, unit: 'g' },
      { id: '7', name: 'dried shrimp', quantity: 1, unit: 'handful' },
      { id: '8', name: 'onions', quantity: 1, unit: 'pieces' },
      { id: '9', name: 'Tomatoes', quantity: 1, unit: 'pieces' },
      { id: '10', name: 'pepper', quantity: 1, unit: 'tbsp' },
      { id: '11', name: 'garlic', quantity: 1, unit: 'cloves' },
      { id: '12', name: 'ginger', quantity: 1, unit: 'piece' },
      { id: '13', name: 'cooking oil', quantity: 1, unit: 'ml' },
    ],
    instructions: [
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'carp', quantity: 1, unit: 'pieces' },
      { id: '2', name: 'Onions', quantity: 1, unit: 'pieces' },
      { id: '3', name: 'Celery', quantity: 1, unit: 'gill' },
      { id: '4', name: 'parseley', quantity: 1, unit: 'gills' },
      { id: '5', name: 'odzom (ginger leaf)', quantity: 1, unit: 'g' },
      { id: '6', name: 'garlic', quantity: 1, unit: 'cloves' },
      { id: '7', name: 'Red chili peppers', quantity: 1, unit: 'pieces' },
      { id: '8', name: 'pèbè', quantity: 1, unit: 'pieces' },
      { id: '9', name: 'Grilled Djansang', quantity: 1 , unit: 'cup' },
      { id: '10', name: 'olive oil', quantity: 1, unit: 'tablespoon' },
      { id: '11', name: 'Lemon juice', quantity: 1, unit: 'tablespoon' },
      { id: '12', name: 'maggi shrimp', quantity: 1, unit: 'pieces' },
    ],
    instructions: [
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'Beans', quantity: 1, unit: 'kg' },
      { id: '2', name: 'Corn', quantity: 1, unit: 'kg' },
      { id: '3', name: 'Palm oil', quantity: 1, unit: 'tbsp' },
      { id: '4', name: 'parsely', quantity: 1, unit: 'sprig' },
      { id: '5', name: 'green onion', quantity: 1, unit: 'cloves' },
      { id: '6', name: 'Crayfish', quantity: 1, unit: 'g' },
      { id: '7', name: 'cube ginger', quantity: 1, unit: 'inch' },
      { id: '8', name: 'habanero', quantity: 1, unit: 'tbsp' },
      { id: '9', name: 'garlic', quantity: 1, unit: 'cloves' },
      { id: '10', name: 'canola oil', quantity: 1, unit: 'tbsp' },
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'wheat flour', quantity: 1, unit: 'kg' },
      { id: '2', name: 'water', quantity: 1, unit: 'l' },
      { id: '3', name: 'Baking powder', quantity: 1, unit: 'packet' },
      { id: '4', name: 'sugar', quantity: 1, unit: 'kg' },
      { id: '5', name: 'frying oil', quantity: 1, unit: 'l' },
      { id: '6', name: 'salt', quantity: 1, unit: 'g' },
      { id: '7', name: 'beans', quantity: 1, unit: 'g' },
      { id: '8', name: 'tomato', quantity: 1, unit: 'pieces' },
      { id: '9', name: 'leek', quantity: 1, unit: 'piece' },
      { id: '10', name: 'peper', quantity: 1, unit: 'piece' },
      { id: '11', name: 'onion', quantity: 1, unit: 'medium' },
      ...
      { id: '15', name: 'Lemongrass leaves', quantity: 1, unit: 'piece' },
    ],
    instructions: [
      'For the donuts',
  ...
  },
  {
    ...
    difficulty: 'easy',
    ingredients: [
      { id: '1', name: 'Beef meat', quantity: 1, unit: 'kg' },
      { id: '2', name: 'tomatoes', quantity: 4, unit: 'pieces' },
      { id: '3', name: 'Cooking oil', quantity: 1, unit: 'ml' },
      { id: '4', name: 'parsely', quantity: 1, unit: 'sprig' },
      { id: '5', name: 'Onion', quantity: 1, unit: 'pieces' },
      { id: '6', name: 'Basil', quantity: 1, unit: 'sprig' },
      { id: '7', name: 'unripe or barely yellowed plantains', quantity: 3, unit: 'kg' },
      { id: '8', name: 'ginger', quantity: 1, unit: 'g' },
      { id: '9', name: 'bongolo', quantity: 1, unit: 'g' },
      { id: '10', name: 'ginger leaves', quantity: 1, unit: 'pieces' },
      { id: '11', name: 'grind peper', quantity: 1, unit: 'tbsp' },
      { id: '12', name: 'garlic', quantity: 1, unit: 'cloves' },
      { id: '13', name: 'peppercorns', quantity: 1, unit: 'pieces' },
      { id: '14', name: 'maggi', quantity: 1, unit: 'pieces' },
    ],
    instructions: [
