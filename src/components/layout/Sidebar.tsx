...
const Sidebar = () => {
  ...
  return (
    <aside className={`w-64 h-screen sticky top-0 left-0 z-40 transform transition-transform duration-300 ease-in-out md:translate-x-0 ${
      location.pathname === '/login' || location.pathname === '/register' 
        ? 'hidden' 
        : '-translate-x-full md:translate-x-0'
    } ${
      theme === 'dark' ? 'bg-gray-800' : 'bg-white'
    } shadow-lg md:shadow-none mt-16 md:mt-0`}>
